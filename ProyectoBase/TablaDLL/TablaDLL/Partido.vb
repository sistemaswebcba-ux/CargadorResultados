...
Public Class Partido
    ...
    Public Sub New()
        ...
        cad = con.Cadena()
    End Sub
    Public Sub CargarResultado(ByVal idpartido As Integer, ByVal gl As Integer, ByVal gv As Integer, ByVal pl As Integer, ByVal pv As Integer, ByVal GanoL As Integer, ByVal GanoV As Integer, ByVal EmpateL As Integer, ByVal EmpateV As Integer, ByVal PerdioL As Integer, ByVal PerdioV As Integer, ByVal fechaPartido As String)
        Dim Sql As String
        Sql = "update fixture"
        ...
        Sql = Sql + ",FechaDate =" + "'" + Convert.ToDateTime(fechaPartido.ToString()) + "'"
